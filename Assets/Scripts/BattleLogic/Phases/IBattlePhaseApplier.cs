...
public interface IBattlePhaseApplier
{
    ...
    /// </summary>
    /// <param displayName="entity">The entity to apply the strategies to.</param>
    /// <param displayName="definition">The entity definition containing base strategy implementations.</param>
